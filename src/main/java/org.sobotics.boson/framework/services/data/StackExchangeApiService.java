...
public class StackExchangeApiService extends ApiService {
    ...
    @Override
    public List<Question> getQuestions(String site, int page, int pageSize, Instant fromDate, Instant toDate, Ordering order,
    ...
    private JsonObject getTagsJson(String site, int page, int pageSize, Ordering order, TagSorting sort, String inName, String filter,
                                   String tagsUrl, String fromDateString, String toDateString) throws IOException {
    ...
    private JsonObject getPostsJson(String site, int page, int pageSize, Ordering order, PostSorting sort, String filter,
                                    String postsUrl, String fromDateString, String toDateString) throws IOException {
